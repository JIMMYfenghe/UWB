...
int GetLocation(vec3d *best_solution, int use4thAnchor, vec3d* anchorArray, int *distanceArray)
{
    ...
    p4.x = anchorArray[3].x;		p4.y = anchorArray[3].y;	p4.z = anchorArray[3].z; //4th same as 1st - only 3 used for trilateration

    /*cm turn to m*/
    r1 = (double) distanceArray[0] / 100.0;
    r2 = (double) distanceArray[1] / 100.0;
    r3 = (double) distanceArray[2] / 100.0;

    r4 = (double) distanceArray[3] / 100.0;
